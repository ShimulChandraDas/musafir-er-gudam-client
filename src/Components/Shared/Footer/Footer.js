...
const Footer = () => {
    ...
    return (
        <footer className='bg-dark mt-5 pt-5 pb-5'>
            <div style={{ maxWidth: 250 }} className=' d-flex  mx-auto align-items-center  justify-content-between pb-4'>
                <a
            ...
            <p className='text-center text-white  '><small>All Rights Reserved By &copy; {year} Musafir</small></p>
        </footer>
    );
};
